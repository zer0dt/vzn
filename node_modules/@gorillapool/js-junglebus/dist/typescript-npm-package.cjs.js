...
var Centrifuge = require('centrifuge/build/protobuf');
...
var Centrifuge__default = /*#__PURE__*/_interopDefaultLegacy(Centrifuge);
...
const ProtobufRoot = protobuf__default["default"].Root.fromJSON(ProtobufDef);
...
class JungleBusSubscription {
    constructor(client, subscriptionID, fromBlock, onPublish, onStatus, onError, onMempool, liteMode = false) {
        ...
        this.subscriptionQueue = new Queue__default["default"](function (tx, cb) {
        ...
        this.mempoolQueue = new Queue__default["default"](function (tx, cb) {
            return __awaiter(this, void 0, void 0, function* () {
                if (onMempool) {
                    yield onMempool(tx);
                }
...
class JungleBusClient {
    ...
    Connect() {
        ...
        client.centrifuge = new Centrifuge__default["default"](`${this.client.useSSL ? 'wss' : 'ws'}://${client.serverUrl}/connection/websocket${(client.protocol === "protobuf" ? '?format=protobuf' : '')}`, {
    ...
    Subscribe(subscriptionID, fromBlock, onPublish, onStatus, onError, onMempool, liteMode = false) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return new JungleBusSubscription(this.client, subscriptionID, fromBlock, (tx) => __awaiter(this, void 0, void 0, function* () {
                if (onPublish) {
            ...
            }), onStatus, onError, (tx) => __awaiter(this, void 0, void 0, function* () {
                if (onMempool) {
                    if (!tx.transaction.length && !liteMode) {
                        const url = `${this.client.useSSL ? 'https' : 'http'}://${this.client.serverUrl}/v1/transaction/get/${tx.id}/bin`;
                        const resp = yield fetch(url);
